...
extension Tospb_Item: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularFloatField(value: &self.price)
      case 4: try decoder.decodeSingularInt64Field(value: &self.categoryID)
      case 5: try decoder.decodeSingularInt64Field(value: &self.orderItemID)
...
extension Tospb_Order: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeRepeatedMessageField(value: &self.items)
      case 4: try decoder.decodeSingularFloatField(value: &self.total)
      case 5: try decoder.decodeSingularStringField(value: &self.status)
      case 6: try decoder.decodeSingularStringField(value: &self.timeOrdered)
      case 7: try decoder.decodeSingularStringField(value: &self.timeComplete)
      default: break
      }
    }
  }
...
extension Tospb_Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.response)
      default: break
      }
    }
  }
...
extension Tospb_OrdersRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.request)
      default: break
      }
    }
  }
